    ...
    try {
      ...
      if (response.ok && data.success) {
        toast({
          ...
          description: "Checking AWS connection...",
        });
        ...
        if (profileData.user?.awsRoleArn) {
          router.push('/chat');
        } else {
          router.push('/onboarding/aws-account');
        }
      } else {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                required
                className="w-full p-3 border rounded-lg bg-white/5 border-white/10 focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full p-3 border rounded-lg bg-white/5 border-white/10 focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors pr-10"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              className="w-full p-3 bg-primary text-white rounded-lg hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:active:scale-100 shadow-lg hover:shadow-xl disabled:shadow-lg"
              disabled={loading}
            >
              {loading ? (
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center gap-2 p-3 border rounded-lg hover:bg-foreground/5 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
              >
