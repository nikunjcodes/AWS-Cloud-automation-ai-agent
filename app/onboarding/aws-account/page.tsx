      ...
      <Card className="max-w-xl w-full">
        <CardHeader>
          ...
          <CardDescription className="text-center text-lg">
            To connect Cloud Navigator Assistant, we need an AWS account.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {!showCreateInstructions ? (
            ...
            <div className="space-y-4 prose dark:prose-invert max-w-none">
              ...
              <p>
                To use Cloud Navigator Assistant's deployment features, you'll need an AWS account. AWS offers a generous Free Tier for new users.
              </p>
